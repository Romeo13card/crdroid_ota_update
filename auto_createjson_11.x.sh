...
path=/hdd/crdroid11                                                             # Here you will need to specify the path to the crDroid source code folder
...
gh release create $nozip --notes "Automated release crDroid 11.x (VANILLA/NON-KSU) for $device $version $date/$time" $path/out/target/product/$device/$zip
