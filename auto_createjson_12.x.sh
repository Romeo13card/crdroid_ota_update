...
nozip=$(basename $path/out/target/product/$device/crDroidAndroid-16.0-*-$device-*.zip .zip) # Here we get the package name without the extension .zip
...
paypal="https://dalink.to/romeo_13card_fan"            # https link (leave empty if unused)
